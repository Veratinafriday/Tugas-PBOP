...
#Objek Buku
buku1 = Buku("0001", "Timun Emas", "Buku Dongeng", "Rak 14", "Dipinjam", "978", " Ali Muakhir", 64, "19x20")
buku2 = Buku("0002","Ensiklopedia Keragaman Budaya", "Buku Referensi", "Rak 1", "Ada", "978-979-053-118-5", "Nurul Akhmad", 132, "25x20")
buku3 = Buku("0003","Kamus Indonesia-Korea", "Buku Referensi", "Rak 1", "Ada", "978-602-667-313-8", "Tri Istiyani", 300, "15x20")
buku4 = Buku("0004","Atlas Dunia", "Buku Referensi", "Rak 1", "Dipinjam", "978-602-434-291-3", "National Geographic Kids", 208, "24x30,5")
...
majalah3 = Majalah("1113", "Elle", "Majalah Cetak", "Rak 5", "Ada", "13", "Kecantikan")
majalah4 = Majalah("1114", "Muslimah", "Majalah Cetak", "Rak 2", "Ada", "12", "Mode & Gaya Hidup")  
majalah5 = Majalah("1115", "Infokomputer", "Majalah Cetak", "Rak 2", "Dipinjam", "III", "Komputer")

#Objek DVD
dvd1 = DVD("1001", "Only You", "softcopy", "Rak 3", "Ada", "Han Yi Joon", "DraKor")
dvd2 = DVD("1002", "Medical Brothers", "softcopy", "Rak 3", "Ada", "Kim Su Hyung", "DraKor")
dvd3 = DVD("1003", "My Sassy Girl", "softcopy", "Rak 3", "Ada", "Cha Tae Hyun", "DraKor")   
dvd4 = DVD("1004", "Like Land and Sky", "softcopy", "Rak 3", "Ada", "Jung Mu Young", "DraKor")
